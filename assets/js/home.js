...
(function (document, window, domIsReady, undefined) {
  ...
  domIsReady(function () {
    ...
    /**
     * Set dynamic value of total years open.
     */
    function setOpeningYear() {
      var totalYearsOpenElem = document.getElementById("totalYearsOpen");
      var now = new Date();
      var SALON_NICK_OPENING_YEAR = 2003;
      // Test if element exist (guard against thrown errors).
      if (totalYearsOpenElem) {
        totalYearsOpenElem.textContent =
          now.getFullYear() - SALON_NICK_OPENING_YEAR;
      }
    }
    /**
